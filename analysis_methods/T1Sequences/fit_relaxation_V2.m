...
% data_in form = [1, no. evolution times x no. evolution fields]
% t form = [no. evolution fields x no. evolution times], in ms
% B0 form = [no. evolution fields x 1], in mT
% LB 16/01/23: modifications to improve code robustness and performances

function [R1out,others,tres,sse,err,fitres] = fit_relaxation_V2(imageSmoothed,t,B0,B0_pol,rois)
%% initialisation
...
% This function can work for both pre-polarised and non-polarised cases, by
% adjusting B0_pol accordingly.
